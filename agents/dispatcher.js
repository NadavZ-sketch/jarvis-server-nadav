...
const REGISTRY = {
    ...
    messaging:  { mode:'sync', invoke:(c,a) => a.runMessagingAgent(c.userMessage, c.supabase, c.useLocal) },
    ...
    factory:    { mode:'sync', invoke:(c,a) => a.runAgentFactoryAgent(c.userMessage, c.supabase, c.useLocal) },
