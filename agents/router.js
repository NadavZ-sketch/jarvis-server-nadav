...
const KEYWORDS = {
    ...
    memory:    /זכור ש|תזכור ש|שמור ש|מה אתה יודע|מה את יודעת|מה ידוע לך|יודע עליי|יודעת עליי|מה זכרת|ספר לי עליי|מה שמרת|מחק זיכרון|הסר זיכרון|שכח ש|מה ה\S+\s+שלי|מהם ה\S+\s+שלי|מה אני אוהב|מה אני שונא/i,
    ...
    project:   /פרויקט|פרוייקט|מיזם|ניהול פרויקט|צור פרויקט|הצג פרויקט|מחק פרויקט|רשימת פרויקטים|הפרויקטים שלי|אבן דרך|אבני דרך|milestone|התקדמות פרויקט|סטטוס פרויקט|ברייפינג פרויקט|תובנות פרויקט/i,
