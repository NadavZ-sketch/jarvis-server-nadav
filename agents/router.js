...
const KEYWORDS = {
    ...
    weather:   /מזג\s*ה?אוויר|תחזית|גשם|שלג|חמסין|סופה|מעונן|שמשי|גשום|טמפרטורה|מעלות|לחות|חום בחוץ|קר בחוץ|חם בחוץ/i,
    ...
    messaging: /שלח.*ווצאפ|שלח.*וואטסאפ|שלח.*מייל|ווצאפ ל|וואטסאפ ל|שלח מייל ל|שלח הודעה ל|שמור.*קשר|הוסף.*קשר|שמור.*טלפון|שמור.*מספר|שלח לי.*קישור|תשלח לי.*קישור|שלח לי.*במייל|תשלח לי.*במייל|שלח לי את הקישור|תשלח לי את הקישור/i,
