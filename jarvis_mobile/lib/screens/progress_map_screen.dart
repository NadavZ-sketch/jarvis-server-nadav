...
class _ProgressMapScreenState extends State<ProgressMapScreen>
  ...
  void _showAgentDetails(Map<String, dynamic> agent) {
    showModalBottomSheet<void>(
      ...
      builder: (_) => _AgentDetailSheet(agent: agent, base: _base),
    );
  }
...
// ══════════════════════════════════════════════════════════════════════════════
// Agent Detail Sheet — 4 tabs: כרטיס · מידע · חיבורים · דאשבורד
// ══════════════════════════════════════════════════════════════════════════════

class _AgentDetailSheet extends StatefulWidget {
  final Map<String, dynamic> agent;
  final String base;
  const _AgentDetailSheet({required this.agent, required this.base});
