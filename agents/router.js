...
const KEYWORDS = {
    ...
    memory:    /זכור ש|תזכור ש|שמור ש|מה אתה יודע|מה את יודעת|מה ידוע לך|יודע עליי|יודעת עליי|מה זכרת|ספר לי עליי|מה שמרת|מחק זיכרון|הסר זיכרון|שכח ש/i,
    ...
    e2e:       /בצע בדיקות קצה|בדיקות קצה לקצה|בדיקת e2e|הרץ בדיקות|דוח בדיקות|end[- ]?to[- ]?end/i,
