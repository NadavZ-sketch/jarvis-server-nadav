...
jest.mock('../../agents/memoryAgent', () => ({
    ...
    setMemoryCacheInvalidator: jest.fn(), getPendingMemory: jest.fn().mockReturnValue(null),
    clearPendingMemory: jest.fn(), saveSessionSummary: jest.fn().mockResolvedValue(undefined),
}));
